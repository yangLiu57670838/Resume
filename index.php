...
<!--	<link rel='stylesheet' href='/bower_components/textAngular/dist/textAngular.css'>-->
	...
	<script charset="utf-8" src="assets/javascripts/textAngular-rangy.min.js"></script>
    <script charset="utf-8" src="assets/javascripts/textAngular-sanitize.min.js"></script>
    <script charset="utf-8" src="assets/javascripts/textAngular.min.js"></script>
...
$(document).ready(function(){
    $("#togglej2").click(function(){
        ...
        if (tj2.innerHTML == 'Add more Jobs..')
            {
                tj2.innerHTML = 'Delete';
            }else
                {
                    tj2.innerHTML = 'Add more Jobs..';
                }
        $("#j2").toggle();
...
$(document).ready(function(){
    $("#togglej3").click(function(){
        ...
        if (tj3.innerHTML == 'Add more Jobs..')
            {
                tj3.innerHTML = 'Delete';
            }else
                {
                    tj3.innerHTML = 'Add more Jobs..';
                }
        $("#j3").toggle();
...
$(document).ready(function(){
    $("#togglej4").click(function(){
        ...
        if (tj4.innerHTML == 'Add more Jobs..')
            {
                tj4.innerHTML = 'Delete';
            }else
                {
                    tj4.innerHTML = 'Add more Jobs..';
                }
        $("#j4").toggle();
...
$(document).ready(function(){
    $("#togglej5").click(function(){
        ...
        if (tj5.innerHTML == 'Add more Jobs..')
            {
                tj5.innerHTML = 'Delete';
            }else
                {
                    tj5.innerHTML = 'Add more Jobs..';
                }
        $("#j5").toggle();
...
<body>
                        ...
                        <li>
                            <a href="#contact" data-toggle="tab" id="contact-step">
                                ...
                                <div class="description">
                                    <span class="first">My Resume / CV</span>
                           ...
                           <div class="col-lg-4 column">
                            ...
                            <div class="row">
                                <div class="col-lg-6 column">
									<div class="row">
                                    <div class="form-group col-lg-12 column">
                                    ...
                                    <div class="form-group col-lg-12 column">
                                        ...
                                        <input id="skype" name="skype" data-validation="" type="text" placeholder="" class="form-control" tabindex="2">
                                    </div>
                                ...
                                <div class="col-lg-6 column">
									<div class="row">
										<div class="form-group col-lg-12 column">
										<label for="photo">Example Photo</label>
                                
                                    </div>
                                    <div class="form-group col-lg-12 column">
							
                                       <img src="asset/images/sample.png" style="">
                                    </div>
										<div class="form-group col-lg-12 column">
 ...
 <h6>Introduction & Objective</h6>

                                    <div class="row">
                                <div class="col-lg-12 column">
                                    <label>Introduction</label>
									 <text-angular-toolbar name="toolbar11" ta-toolbar="[['bold', 'italics', 'ul', 'redo', 'undo', 'insertLink']]"></text-angular-toolbar>
              <text-angular name="htmlcontent6" ng-model="viewEmployment.editableValue6" ta-target-toolbars='toolbar11,toolbar12' ng-change="enableEditorButtons(viewEmployment.id6)"></text-angular>
              <text-angular-toolbar name="toolbar12" ta-toolbar="[['html', 'charcount', 'wordcount']]"></text-angular-toolbar>
									
									
<!--
                                    <textarea class="form-control" onKeyDown="limitText(this.form.introduce,this.form.countdown,320);" onKeyUp="limitText(this.form.introduce,this.form.countdown,320);" rows="5" name="introduce" id="introduce" placeholder="Introduce yourself here"></textarea>
                                    <font size="2">(Maximum characters: 320)
You have <input readonly type="text" name="countdown" size="3" value="320" class="count">characters left.</font>
-->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 column">
                                    ...
                                    <textarea class="form-control" onKeyDown="limitText(this.form.objective,this.form.countdown2,400);" onKeyUp="limitText(this.form.objective,this.form.countdown2,400);" rows="5" name="objective" id="objective" placeholder="Explain your objectives here – e.g. To work for a company that gives me the platform to develop a new skill set while utilizing my present knowledge."></textarea> <font size="2">(Maximum characters: 400) You have <input readonly type="text" name="countdown2" size="3" value="400" class="count">characters left.</font>
                                </div>
                            </div>
             ...
             <h6>Skills</h6>  
                                ...
                                <div class="col-lg-12 column">
                                    ...
                                    <textarea class="form-control" rows="5" name="skill1" id="skill1" placeholder="Please include 5 or 6 skills that you can offer your potential employer. I.e hard working, great customer service etc."></textarea>
                                </div>
                            </div>
  <h6> Education</h6>  
                             <div class="row">
                        ...
                        <div class="row">
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="educationfrom1" name="educationfrom1" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>
                                    </div>
                                </div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="educationto1" name="educationto1" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                            
                            </div>
                                ...
                                <div class="col-lg-8 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="educationfrom2" name="educationfrom2" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>
                                    </div>
                                </div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="educationto2" name="educationto2" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                            
                            </div>
                                ...
                                <div class="col-lg-8 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="educationfrom3" name="educationfrom3" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>
                                    </div>
                                </div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        <label for="educationto3">Toooo</label>
                                        <div class="input-group date">
                                            <input id="educationto3" name="educationto3" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                            
                            </div>
 ...
 <h6>Certificates & Licences</h6>
         
                                                           <div class="row">
                                <div class="col-lg-6 column">
                                    <label>Certificates</label>
                                    <textarea class="form-control" rows="5" name="certificate" id="certificate" placeholder="Do not include any school or college certificates or grades"></textarea>
                                </div>
                                <div class="col-lg-6 column">
                                ...
                                <div class="col-lg-6 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jfrom1" name="jfrom1" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>       
                                    </div>
                                       </div></div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jto1" name="jto1" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                           
                                </div>  
                             <div class="row">
                                <div class="col-lg-12 column">
                                    ...
                                    <textarea class="form-control" rows="5" name="duty1" id="duty1" placeholder="Include 5 or more duties. The employers want to know exactly what you did on a day to day basis. e.g. Respond to customer enquiries daily through phone, email and in-person"></textarea>
                                </div>
                            </div>  
                               <br>
           <a id="togglej2" style="cursor:pointer">Add more Jobs..</a>
                                ...
                                <div class="col-lg-6 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jfrom2" name="jfrom2" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>       
                                    </div>
                                       </div></div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jto2" name="jto2" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                           
                                </div>  
                             <div class="row">
                                <div class="col-lg-12 column">
                                    <label>Job Duties</label>
                                    <textarea class="form-control" rows="5" name="duty2" id="duty2" placeholder="Include 5 or more duties. The employers want to know exactly what you did on a day to day basis. e.g. Respond to customer enquiries daily through phone, email and in-person"></textarea>
                                </div>
                            </div> 
                <a id="togglej3" style="cursor:pointer">Add more Jobs..</a>
                                ...
                                <div class="col-lg-6 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jfrom3" name="jfrom3" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>       
                                    </div>
                                       </div></div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jto3" name="jto3" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                           
                                </div>  
                             <div class="row">
                                <div class="col-lg-12 column">
                                    <label>Job Duties</label>
                                    <textarea class="form-control" rows="5" name="duty3" id="duty3" placeholder="Include 5 or more duties. The employers want to know exactly what you did on a day to day basis. e.g. Respond to customer enquiries daily through phone, email and in-person"></textarea>
                                </div>
                            </div> 
                                  <a id="togglej4" style="cursor:pointer">Add more Jobs..</a>
                                ...
                                <div class="col-lg-6 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jfrom4" name="jfrom4" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>       
                                    </div>
                                       </div></div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jto4" name="jto4" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                           
                                </div>  
                             <div class="row">
                                <div class="col-lg-12 column">
                                    <label>Job Duties</label>
                                    <textarea class="form-control" rows="5" name="duty4" id="duty4" placeholder="Include 5 or more duties. The employers want to know exactly what you did on a day to day basis. e.g. Respond to customer enquiries daily through phone, email and in-person"></textarea>
                                </div>
                            </div> 
                        <a id="togglej5" style="cursor:pointer">Add more Jobs..</a>
                                ...
                                <div class="col-lg-6 column">
                                   ...
                                   <div class="col-lg-5 column">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input id="jfrom5" name="jfrom5" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>       
                                    </div>
                                       </div></div>
                           <div class="col-lg-5 column" id="dateofreturn">
                                    <div class="form-group">
                                        <label for="jto4">To</label>
                                        <div class="input-group date">
                                            <input id="jto5" name="jto5" data-validation="mand" type="text" class="form-control" placeholder="mm-yyyy" tabindex="4"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                        </div>  
                                    </div>
                                </div>                           
                                </div>  
                             <div class="row">
                                <div class="col-lg-12 column">
                                    <label>Job Duties</label>
                                    <textarea class="form-control" rows="5" name="duty5" id="duty5" placeholder="Include 5 or more duties. The employers want to know exactly what you did on a day to day basis. e.g. Respond to customer enquiries daily through phone, email and in-person"></textarea>
                                </div>
                            </div> 
                            ...
                            <div class="row next text-center">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-3 col-md-offset-6 col-lg-3 col-lg-offset-6 column">
                                    <button id="contact-btn" class="btn btn-primary btn-hg step"  tabindex="18" disabled>
                                        Submit
                                    </button>
                                </div>
                            </div>
